...
constexpr auto qt_meta_stringdata_CLASSQuickSortENDCLASS = QtMocHelpers::stringData(
    "QuickSort",
    "finished",
    "",
    "runSort"
...
void QuickSort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QuickSort::*)();
            if (_t _q_method = &QuickSort::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
