...
constexpr auto qt_meta_stringdata_CLASSHeapSortENDCLASS = QtMocHelpers::stringData(
    "HeapSort",
    "finished",
    "",
    "runSort"
...
void HeapSort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (HeapSort::*)();
            if (_t _q_method = &HeapSort::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
