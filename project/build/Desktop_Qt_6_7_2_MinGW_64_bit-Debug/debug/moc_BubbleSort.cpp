...
constexpr auto qt_meta_stringdata_CLASSBubbleSortENDCLASS = QtMocHelpers::stringData(
    "BubbleSort",
    "finished",
    "",
    "runSort"
...
void BubbleSort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BubbleSort::*)();
            if (_t _q_method = &BubbleSort::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
